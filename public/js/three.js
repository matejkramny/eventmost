$(document).ready(function() {
	// Dropdown toggles
	$(".dropdown dt a, .dropdown2 dt a, .dropdown3 dt a").click(function() {
		$(this).parent().parent().find("dd ul").toggle();
	});
	
	$(".dropdown dd ul li a, .dropdown2 dd ul li a, .dropdown3 dd ul li a").click(function() {
		var text = $(this).html();
		$(this).parentsUntil('.dropdown,.dropdown2,.dropdown3').parent().find("dt a").html(text);
	...
	$(document).bind('click', function(e) {
		...
		if (! $clicked.parent().hasClass("dropdown")) {
			$(".dropdown dd ul, .dropdown2 dd ul, .dropdown3 dd ul").hide();
		}
	});
