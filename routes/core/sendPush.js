...
exports.sendIOSPushNotificationToAtendees = function(senderId, regIds, message) {
    var status = true;
    var msg;
    var desc;
        try{
            if(regIds){
                ...
                if(apnConnection) {
                    apnConnection.pushNotification(note, regIds);
                }
...
exports.sendAndroidPushNotificationToAtendees = function(senderId, regIds, message) {
    //var message = new gcm.Message();
        try{
            if(regIds) {
                var message = new gcm.Message({
...
*/
                ...
                console.log("Android regIds: " + regIds);
                var sender = new gcm.Sender('AIzaSyC8r1IGFX_dfSHP1d8O1m__88zAA1QtkVU');
