		...
		async.parallel([
			...
			function (cb) {
				...
				if(otherUser.isFeedbackProfile == true){
					...
					var replylink = 'http://eventmost.com/reply-feedback-message/'+msg._id+'/'+req.user._id+'/'+otherUser._id;
