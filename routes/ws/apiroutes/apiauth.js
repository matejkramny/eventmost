		...
		if (user) {
			...
			models.User.update(query, {$set : {password: newpassword}}, function (err){
				...
				var options = {
					...
					html: "<img src=\"http://eventmost.com/images/logo.png\"><br/><br/><p><strong>Hi,</strong><br/><br/>Your password was changed at "+moment().format('DD/MM/YYYY HH:mm:ss')+".<br/>If you have not authorised this, please contact us <strong>IMMEDIATELY</strong> at <a href='mailto:support@eventmost.com'>support@eventmost.com</a>"
				}
