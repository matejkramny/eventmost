var fs = require('fs'),
	...
	, feedbackinbox = require('./apifeedbackInbox')
	, config = require('../../../../../config')

exports.router = function (app) {
	app.get('/api/event/:id/admin/feedback', eventFeedbackProfile)
		.get('/api/event/:id/admin/feedback/new', newFeedbackProfile)
		.post('/api/event/:id/admin/feedback/edit', getProfile, doEditFeedbackProfile)
		.get('/api/event/:id/admin/feedback/:fid', getProfile, editFeedbackProfile)
		.all('/api/event/:id/admin/feedback/:fid/*', getProfile)
