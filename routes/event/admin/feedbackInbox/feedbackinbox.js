		...
		models.Message.find({
		  ...
		  .sort('-timeSent').exec(function(err, messages) {
			...
			if (!messages[0].sentBy.avatar.length)
				...
				var avatarUrl = "http://eventmost.com/"+messages[0].sentBy.avatar;
			var messagehtml;
			if (messages.length == 0)
				...
				if (messages.length <= 2) {
					if (!messages[1].sentBy.avatar.length)
						...
						var avatarUrl = "http://eventmost.com/"+messages[1].sentBy.avatar;
