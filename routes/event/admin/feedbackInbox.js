			...
			if(res.locals.receivedCards && res.locals.receivedCards.length > 0){
				...
				res.locals.receivedCards.forEach(function (thiscard){
					var item = {
						...
						avatar: "http://dev.eventmost.com"+((thiscard.from.avatar != '') ? thiscard.from.avatar : '/images/default_speaker.svg'),
						message: '',
						card: "http://dev.eventmost.com/businesscards/"+thiscard.card._id+".png"
					}
