			...
			if(comments.length > 0){
				...
				async.each(comments,
				  ...
				  function(err){
				    ...
				    var eventAvatar = ((ev.avatar)? String(ev.avatar) : 'http://dev.eventmost.com/images/default_speaker-purple.png');
				    if(eventAvatar != ''){
