				...
				async.each(comments,
				  ...
				  function(item, callback){
					...
					models.Attendee.findOne({"_id": mongoose.Types.ObjectId(attendee_id)}).populate("user").exec(function (err, usr){
						...
						var replylink = 'http://eventmost.com/reply-feedback/'+thisCommentId+'/'+user_id+'/'+feedback_profile_id;
						var profileImg = ((usr.user.avatar != '') ? 'http://eventmost.com'+usr.user.avatar : 'http://eventmost.com/images/default_speaker-purple.png');
